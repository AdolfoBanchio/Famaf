...
la funcion para el polinomio interpolante esta definida en ilagrange.py,
es la que defini en el practico 3. Toma como parametros los (xi,yi) a interpolar y 
un set de valores a los que evaluar ese polinomio interpolante. De retorno devuelve 
el resultado del polinomio para cada uno de esos valores.
"""
...
longitud(t)
latitud(t)
para ello creo una figura con dos graficos, y al primero le
agrego los graficos correspondientes a los puntos interpolados
(latitud/longitud cada 3 hs) extraidos del archivo. y tambien
agrego las funciones de interpolacion pero evaluadas cada 1hs
